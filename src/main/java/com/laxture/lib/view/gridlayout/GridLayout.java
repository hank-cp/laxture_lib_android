...
package com.laxture.lib.view.gridlayout;
...
public class GridLayout extends ViewGroup {
    ...
    private static final int DEFAULT_GAP = R.styleable.GridLayout_defaultGap;
    ...
    public GridLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            setDefaultGap(a.getDimensionPixelOffset(DEFAULT_GAP, defaultGap));
        } finally {
            a.recycle();
        }
    ...
    /**
     * When {@link #setUseDefaultMargins(boolean)} is set to {@code true},
     * this value will be used as default margin between child views.
     *
     * @return
     */
    ...
    /**
     * Set default margin that will be allocated between child views when
     * {@link #setUseDefaultMargins(boolean)} is set to {@code true}
     *
     * @param defaultGap
     */
    public void setDefaultGap(int defaultGap) {
