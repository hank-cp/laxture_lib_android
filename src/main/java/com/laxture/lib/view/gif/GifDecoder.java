...
public class GifDecoder {
    ...
    /**
     * Reads GIF image from file
     *
     * @param file gif file to load
    ...
    public int read(File file) {
        try {
            ...
            LLog.w("Read gif file %s failed", file);
    ...
    protected void readBitmap() {
        ...
        if (mDensity > 0) image.setDensity(mDensity);
    ...
    public int size() {
        ...
        for (int i=0; i<getFrameCount(); i++) {
            size += BitmapUtil.getBitmapSize(getFrame(i));
        }
        return size;
    }
